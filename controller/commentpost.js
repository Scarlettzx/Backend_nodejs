...
module.exports = {
  ...
  createCommentpostbyuser: (req, res) => {
    ...
    createCommentpostbyuser(body, createAt, (err, commentResults) => {
      if (err) {
        console.log(err);
  ...
  // ! createCommentpostbyband
  createCommentpostbyband: (req, res) => {
    const body = req.body;
    const createAt = myDateModule.getCurrentDateTimeFormatted();
    // const updateAt = myDateModule.getCurrentDateTimeFormatted();
  ...
  getCommentbypostid: (req, res) => {
    ...
    getCommentbypostid(post_id, (err, results) => {
      if (err) {
        console.log(err);
        return;
      }
